...
describe('Avatar Component | Valid Image', () => {
  const component = (
    <ThemeContext.Provider value={{ themeZoom, setThemeZoom }}>
      <ThemeProvider>
        <Avatar src="https://material-ui.com/static/images/avatar/2.jpg" name="Genzo Wonzo" size="xs" shape="square" />
      </ThemeProvider>
...
describe('Avatar Component | Invalid Image', () => {
  const component = (
    <ThemeContext.Provider value={{ themeZoom, setThemeZoom }}>
      <ThemeProvider>
        <Avatar src="https://www.gravatarz.com/avatar/fooff" name="Natasha Special" size="xl" shape="round" border />
      </ThemeProvider>
    </ThemeContext.Provider>
  )
