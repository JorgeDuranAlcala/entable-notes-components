...
export default function Label(props: LabelProps) {
  ...
  return li ? (
    <li style={{ backgroundColor: bgColor, color }} className={cls} onClick={(e: any) => onClick && onClick(e)}>
      {value}
    </li>
  ) : (
    <div style={{ backgroundColor: bgColor, color }} className={cls} onClick={(e: any) => onClick && onClick(e)}>
      {value}
    </div>
  )
}
