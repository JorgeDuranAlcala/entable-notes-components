...
export function getFirstTabbableIn<T extends Element>(container: T, fallbackToFocusable?: boolean): T | null {
  const [first] = getAllTabbable(container, fallbackToFocusable)
  return first || null
}

export function getLastTabbableIn<T extends Element>(container: T, fallbackToFocusable?: boolean): T | null {
  const allTabbable = getAllTabbable(container, fallbackToFocusable)
  return allTabbable[allTabbable.length - 1] || null
}

export function getNextTabbable<T extends Element>(container: T, fallbackToFocusable?: boolean): T | null {
  const allFocusable = getAllFocusable(container)
...
export function getPreviousTabbable<T extends Element>(container: T, fallbackToFocusable?: boolean): T | null {
...
export function focusPreviousTabbable<T extends Element>(container: T, fallbackToFocusable?: boolean) {
